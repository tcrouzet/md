...
D’où je tire ça ? De minces chiffres, il est vrai. [*Ératosthène*](http://blog.tcrouzet.com/eratosthene/) est sorti depuis une semaine, c’est un bide commercial pour l’instant, on peut voir les choses comme ça. C’est même un bide critique, avec une poignée d'articles à ce jour ([merci à vous, les courageux aventuriers](http://blog.tcrouzet.com/eratosthene/ertosthene-revue-de-presse/)). Mais j’ai assez de ventes ebooks pour détecter un changement. Amazon représente moins de 25 % du marché.

![Répartition des 30 premières ventes d'Ératosthène.](http://blog.tcrouzet.comhttps://tcrouzet.com/images_tc/2014/09/j7stat.png)
...
![Amazon pèse beaucoup moins qu'Apple au global.](http://blog.tcrouzet.comhttps://tcrouzet.com/images_tc/2014/09/statall.png)

Amazon pèse beaucoup moins qu'Apple au global.
...
![Ventes Amazon](http://blog.tcrouzet.comhttps://tcrouzet.com/images_tc/2014/09/betavente-600x498.png)

Petite explication. Je construis ce graphique en relevant automatiquement toutes les heures le classement du livre dans le top Amazon. Chaque pic correspond à une vente. La méthode est assez efficace. Pour [*J’ai débranché*](http://blog.tcrouzet.com/jai-debranche/jai-debranche-statistiques/), j’obtiens des chiffres très proches de ceux communiqués par Fayard.
...
![Dans mes ventes globale ebook, Amazon reste dominateur (mais ça change peut-être).](http://blog.tcrouzet.comhttps://tcrouzet.com/images_tc/2014/09/statamazon1.png)

Dans mes ventes globale ebook, Amazon reste dominateur (mais ça change peut-être).



Tags: Amazon, eBook, édition, une