---
metatitle: Pourquoi je ne peux pas quitter Substack
metadescription: Découvrez pourquoi quitter Substack reste compliqué malgré ses dérives. Comparatif des alternatives (Ghost, Beehiiv) et analyse des coûts réels.
---

# Pourquoi je ne peux pas quitter Substack

[Quand j’ai souligné les dérapages pour le moins indélicats de Substack](https://tcrouzet.com/2025/11/22/substack-dsa-censure-palestinien/), on m’a crié : « Qu’est-ce que tu fais encore là ? » On m’a traité de collaborateur comme je traite souvent de collaborateurs ceux encore présents sur les réseaux sociaux privés et manipulateurs. Est-ce si simple ? La fuite est-elle toujours la meilleure solution ?

Je vis en France. Dois-je fuir parce que nos forces de l’ordre sont violentes, racistes, pratiquent la surveillance de masse, les contrôles d’identité discriminatoires et maltraitent les migrants selon [Amnesty International](https://www.amnesty.org/en/location/europe-and-central-asia/western-central-and-south-eastern-europe/france/report-france/) ? Dois-je fuir parce que nous ne faisons pas grand-chose pour lutter contre les dérèglements climatiques ? Dois-je fuir parce qu’une bonne partie de la population vote pour des partis politiques extrémistes et populistes ? Je pourrais allonger cette liste de questions quasi infiniment.
...
3. S’exiler en Suisse.
4. Rejoindre les forces libres en Angleterre.
5. Résister de l’intérieur.
...
Sinon, des dizaines d’outils de webmarketing se disputent le marché : [Mailchimp](https://mailchimp.com/), [Mailjet](https://www.mailjet.com/), [Omnisend](https://www.omnisend.com/), [Buttondown](https://buttondown.com/), [MailerLite](https://www.mailerlite.com/)… tous vite hors de prix à l’exception de [Kit](https://kit.com/), gratuit jusqu’à 10K abonnés avec envois illimités. Ce n’est pas ce que je cherche. Je me fiche de traquer mes abonnés, de les cibler, de contrôler leurs clics et d’évaluer un quelconque taux de retour.

Par ailleurs, je n’ai pas envie d’installer un serveur de newsletter comme [Listmonk](https://listmonk.app/) avec en prime la nécessité de le connecter à un mailler (autant installer Ghost). [J’ai choisi de servir mes pages web en statique](https://tcrouzet.com/2025/11/16/smolweb-smolnet/), je ne ferai pas marche arrière. 
