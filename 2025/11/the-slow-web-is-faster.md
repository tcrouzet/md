---
metatitle: "Slow web : minimalisme et impact carbone comparés"
metadescription: "Découvrez pourquoi le slow web est plus rapide. Comparatif impact carbone : site statique, WordPress, Substack, newsletters. Adoptez le minimalisme numérique."
substack: "Site vs Substack : comparatif d'impact écologique et performances"
---

# Le slow web est plus rapide : minimalisme numérique et impact carbone

![Minimal](_i/minimal.webp)
...
![Radios 01](_i/radios.webp)

Quand j’écris mes livres, je ne cesse de les couper, sans jamais atteindre le minimalisme de [Ronald Johnson dans sa série *Radios*](https://www.under-erasure.com/artists-writers/ronald_johnson/) (1977), [Lucien Suel avec ses poèmes express](https://www.derniertelegramme.fr/produit/le-livre-des-poemes-express/) (1987), [Austin Kleon avec sa blackout poetry](https://austinkleon.com/category/newspaper-blackout-poems/) (2005) ou [Philippe Castelneau avec ses tableaux textuels](https://philippe-castelneau.com/2025/10/31/%f0%9f%8e%83-lecture-de-feu/) (2025).
...
J’ai ensuite éliminé les JavaScript non indispensables, ne gardant que la fonction associée au bouton de partage et celle qui charge automatiquement [les articles les uns à la suite des autres selon le monde rouleau](https://tcrouzet.com/2014/10/26/ce-qui-manque-au-blog-ou-la-revolution-litteraire/). Le texte à lire occupe désormais l’essentiel de mes pages.

### Le minimalisme numérique

[Le slow web](https://www.are.na/morgan-sutherland/slow-web) est un mouvement de promotion des usages éthiques, respectueux, réfléchis et durables d’Internet : respect de la vie privée (pas de collecte d’informations), design simple et non manipulateur, pas d’incitation à la surenchère, mise en avant des qualités plutôt que des performances. Je me suis depuis longtemps engagé sur cette voie, tout en découvrant que le slow web n’avait rien de slow. Plus je simplifie mon infrastructure, plus je minimalise mon design, plus mon site est rapide.

Dans un dernier effort pour aller plus loin, j’ai tenté de produire [une version encore plus respectueuse de la philosophie slow web](https://static.tcrouzet.com/) (j’ai dû reprendre une bonne partie du code python de mon générateur). J’ai renoncé à utiliser des polices externes, j’ai supprimé le JavaScript, j’ai gratté encore quelques lignes dans mon CSS et mon HTML et j’ai minimisé la taille des images pour réduire la bande passante consommée.

![Version Slow Web](_i/comp05.webp)

J’ai alors [comparé les performances](https://pagespeed.web.dev/) de [la version officielle](https://tcrouzet.com/) (qui tourne sur un disque cloud), [la version slow web](https://static.tcrouzet.com/) (hébergée gratuitement sur GitHub) et [la version Substack](https://tcrouzet.substack.com/). Malgré un serveur théoriquement moins performant, mais au prix de quelques sacrifices, la version slow web est la plus rapide, tandis que la version Substack est presque dix fois plus lente.

![Perfs comparées](_i/comp02.webp)

![Données PageSpeed](_i/comp03.webp)

Selon [Global Initiatives](https://globalclimateinitiatives.com/calcul-du-bilan-carbone-dun-site-web/), « Un code inefficace sollicite davantage les systèmes informatiques, ralentit le site et accroît son empreinte carbone. » [Une autre étude](https://research.vu.nl/ws/portalfiles/portal/130183911/Investigating_the_Correlation_between_Performance_Scores_and_Energy_Consumption_of_Mobile_Web_Apps.pdf) montre une corrélation entre la consommation énergétique et les performances médiocres des web apps.
...
* [static.tcrouzet.com](https://static.tcrouzet.com/) : pas de JS, pas de polices externes, un CSS directement dans le HTML, une structure linéaire → quasi aucun calcul → énergie minimale.

* [tcrouzet.com](https://tcrouzet.com/) : images HD, CSS, polices et JS externes → coût modéré.

* [Substack](https://tcrouzet.substack.com/) : scripts lourds, tracking des utilisateurs, composants invisibles, chargements différés → calcul + stockage + transferts + reflows → énergie maximale.
...
![Attention : échelle log](_i/comp14.webp)

![Données brutes PageSpeed](_i/comp15.webp)
...
![Score de tcrouzet.com](_i/comp07.webp)
...
![Substack pas terrible](_i/comp09.webp)

![Données brutes](_i/comp13.webp)
...
*PS2 : On me parle de [small web](https://smolweb.org/index.html), je connaissais pas (et j’apprends que ce serait le nouvelle dénomitation de slow web — pour bien incisté sur le fait que ce n’est pas nécessairement lent). Je vien de tester leur validateur et il déclare fautives toutes les balises destinées à optimiser la vitesse de chargement et réduire la bande passante consommée. C’est un peu paradoxal. Pour restecter ce standard, destiné à rendre les pages lisibles même sur des machines minimaiste, je devrais accroîte l’impact carbone de mes pages.*
