...
Canevas écrit en préparation de la conférence donnée à Villeneuve-d’Ascq, université Lille 3, à l’invitation des étudiants du [master GIDE de l’UFR IDIST](http://egide2011.jimdo.com/programme-de-la-journ%C3%A9e/). Je résume les grandes idées exposées dans *[L’alternative nomade](../../books/alternative-nomade.md)*.

### Les dangers du GPS

J’ai donné début mars une [conférence à Villeurbanne](le-libre-et-la-liberte.md). Comme le lendemain je devais rejoindre ma famille dans une station des Alpes du Sud, j’ai pris la voiture. J’avais bien cherché à faire le trajet en train, mais c’était tout simplement impossible. Le site de la SNCF m’annonçait 11 heures de parcours et me faisait arriver à 50 km de ma destination.
...
Il est intéressant de constater que si on trace l’évolution de la complexité, par exemple en représentant la démographie (plus on est nombreux, plus la société a de chance d’être complexe) et si on la compare à l’évolution de la liberté, [on obtient des courbes synchrones](../../2010/8/surpopulation-implique-democratie.md).
...
#netculture #dialogue #y2011 #2011-3-17-13h30
