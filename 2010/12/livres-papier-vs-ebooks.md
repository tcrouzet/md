...
Quand je sortais des livres papier avec un éditeur traditionnel, je n’ai jamais vendu moins de 3 000 exemplaires. Aujourd’hui, quand avec [L’expérience inédite](https://tcrouzet.com/tune-caniveau/experience-inedite/) je sors [*La tune dans le caniveau*](https://tcrouzet.com/tune-caniveau/), j’en vends 86 ! Il est temps de faire un bilan d’une aventure éditoriale expérimentale.<span id="more-20785"></span>

Petit résumé. En septembre, je lance l’idée de créer [un commando pour éditer un texte sans l’apport du moindre capital](https://tcrouzet.com/2010/09/13/experimentons-le-revenu-unique-pour-les-auteurs/) mais tout en respectant une logique éditoriale, c’est-à-dire travail sur le manuscrit, corrections, montage, façonnage et distribution. Mon but : montrer qu’on peut aujourd’hui éditer autrement.

Dès le lendemain, [l’équipe](https://tcrouzet.com/tune-caniveau/experience-inedite/) est sur pied et nous commençons à travailler sur un texte d’une trentaine de pages que j’ai écrit en quatre jours pour l’occasion.

Avons-nous dès ce moment commis une erreur, c’est-à-dire travaillé un texte qui n’en valait pas la peine ? C’est possible, d’ailleurs peu de [chroniqueurs](https://tcrouzet.com/tune-caniveau/rp/) ont été dithyrambiques, et nombre de mes amis du monde des ebooks n’ont même pas écrit la moindre ligne sur le texte.
...
On voulait s’offrir une bouffe avec les bénéfices. [Selon le principe du prix d’auteur unique](https://tcrouzet.com/2010/10/14/veritables-prix-edition/), on a gagné 86 x 1,5 euros, soit 129 euros. Pour le moment, on peut se payer un verre.

### Et le gagnant est…

Pour essayer de faire parler du livre, avec [Bookeen](http://www.bookeen.com/fr/), on a lancé [un petit concours](https://tcrouzet.com/tune-caniveau/concours/) qui se termine aujourd’hui. L’idée était de faire gagner une liseuse [Cybook Orizon](http://www.bookeen.com/fr/cybook/?id=2). [Une vingtaine de blogueurs ont participé.](https://tcrouzet.com/tune-caniveau/rp/)
...
16. [amotsdelies.free.fr](http://amotsdelies.over-blog.com/article-la-tune-dans-le-caniveau-59705635.html%20) (2 visiteurs)
...
Je peux aussi analyser plus spécifiquement le trafic de la page dédiée à [*La tune dans le caniveau*](https://tcrouzet.com/tune-caniveau/). Cette page à été affichée 2 527 fois pour un total de 1 913 consultations uniques.

![](https://tcrouzet.com/images_tc/2010/12/tune2.png)

La blogosphère a généré 43 % du trafic, dont seulement 5 % imputables aux chroniqueurs. Les réseaux sociaux comptent pour 22 %. Par rapport à mon article [sur leur inutilité dans l’absolu](https://tcrouzet.com/2010/12/05/les-reseaux-sociaux-ne-servent-a-rien/), on voit que pour des sites à faible trafic comme le mien leur influence est loin d’être négligeable, bien supérieure à celle de Google.
