...
J’ai pour ma part continué à modifier tous mes textes même après leur parution. Par exemple, je diffuse en numérique une version augmentée du [*Peuple des connecteurs*](https://tcrouzet.com/le-peuple-des-connecteurs/). J’ai commencé à écrire une préface à [*La stratégie du cyborg*](https://tcrouzet.com/la-strategie-du-cyborg/) et j’ai déjà publié [un texte](https://tcrouzet.com/2010/08/04/autore-cyborg/) que je voudrais placer en postface.

J’ai décidé d’appliquer cette méthode avec [*La tune dans le caniveau*](https://tcrouzet.com/tune-caniveau/). Mon idée, placer un texte avant le début actuel, densifier le milieu, peut-être ajouter un texte qui vient après.

Je n’aurais pas songé à ces modifications sans les remarques qui m’ont été faites par mail, en commentaire ou sur [les blogs qui ont parlé du texte](https://tcrouzet.com/tune-caniveau/#presse).
