...
Libérateur, mais aussi rémunérateur. Il ne faut pas se voiler la face. Nous gagnons souvent plus avec un éditeur qu’en solo. Quand les gourous du web, moi compris, avons prévu l’avènement de l’artisanat numérique, nous nous sommes plantés. Ce n’est pas parce que la technologie offre une possibilité qu’elle advient. Le web est devenu une métaplateforme pour d’autres plateformes qui avalent les indépendants, les noient, les dépouillent de leur valeur ajoutée. J’ai appelé ça la [plateformisation](http://tcrouzet.com/2014/09/16/la-fin-de-lartisanat-numerique/), d’autres ont parlé plus tard d’ubérisation.
