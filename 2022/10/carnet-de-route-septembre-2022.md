...
Si je définis le roman comme « raconter par écrit » comment pourrait-il mourir ? Ça n’a aucun sens. Seuls ceux qui sont incapables de raconter peuvent imaginer que le roman est mort. Certaines de ses formes sont mortes, parce qu’elles ont déjà donné leur suc, et *Hippies* use d’une de ces formes, et néanmoins il fonctionne parce que la fonction narrative subsiste. C’est le roman non narratif qui est mort, cette anomalie promue au XX^e^ siècle.
