...
Choisir de diffuser un texte en [Creative Common BY-SA](http://creativecommons.org/licenses/by-sa/3.0/), c’est aussi choisir la transparence dans le processus éditorial. Pour motiver un éditeur à rejoindre le projet, voici l’argumentaire de [*L’homme qui lave les mains*](il-vous-a-peut-etre-sauve-la-vie.md).
...
1. Vous avez aimé [*L’homme qui plantait des arbres*](../../2010/7/le-petit-livre-de-la-revolution.md), vous aimerez *L’homme qui lave les mains*. Comme Elzéard Bouffier, le héros de Giono, Didier Pittet change le monde avec un geste simple.
