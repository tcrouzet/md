---
metatitle: "Coros Dura GPS : le verdict après un an de bikepacking"
metadescription: "50 % de batterie après 10 jours en bikepacking : le Coros Dura a fait ses preuves. Découvrez pourquoi les bikepackers doivent lâcher leur Garmin."
---
...
![No re-route, indispensable en bikepacking](_i/2026-04-24-155822.webp)
...
![Map sur l’app](_i/2026-04-24-161215.webp)
...
* Préréglage du zoom. Au départ d’une trace, je dois systématiquement zoomer au maximum, car le 200 m par défaut ne se me sert strictement à rien.
...
* Ne plus prendre en compte les descentes dans le pourcentage total d’une montée. Le Dura se contente de diviser le dénivelé par la distance.
...
* Mieux gérer les GPX très longs (Garmin ne sait pas faire non plus). J’évite les traces de plus de 250 km. Je ne sais pas à partir de combien de points le Dura commence à perdre les pédales (8 000 pour un Garmin).
...
![Profil VTT](_i/2026-04-24-170255.webp)

![Map plein écran thumb](_i/2026-04-24-172057.webp)

Par défaut, je suis sur la cartographie, avec en bas la distance du prochain POI (ce qui s’avère très pratique en longue distance, notamment pour les points d’eau). En montée, le profil s’affiche sur le tiers inférieur de l’écran, ce qui permet de suivre la trace (bien plus sioux que le climb pro des Garmin). Mon but : que la carte occupe la surface maximale. Toute autre information est une distraction.

![Écran quand je suis pas de trace](_i/2026-04-24-172424.webp)
...
![Paramètres accéssoires](_i/2026-04-24-172612.webp)
