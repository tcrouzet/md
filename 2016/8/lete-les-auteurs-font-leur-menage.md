...
Pour ma part, [j’ai clarifié il y a quelques mois ma position](../3/lettre-amicale-a-augustin-trapenard-les-auteurs-comme-docteurs.md), j’imite le toubib qui est tantôt généraliste et travaille à son compte (je m’autoédite), tantôt fait des missions dans le privé (je signe avec un éditeur).
...
Comme je le disais il y a quelques jours, [j’ai récupéré les droits de la plupart de mes textes édités](../7/recuperer-ses-droits-dauteur-et-apres.md) pour les autoéditer chez Thaulk. J’ai aussi prévu de compiler des textes initialement publiés sur le blog et qui forment des ensembles cohérents, par exemple mes vagabondages, mes carnets, mes textes sur l’édition… J’ai lancé le chantier et les deux premières rééditions sont disponibles : *[La mécanique du texte](../../page/la-mecanique-du-texte)* (version révisée et augmentée) et *[Ératosthène](../../page/eratosthene)* (version intégrale avec le journal d’écriture qui n’était disponible jusqu’alors qu’en ebook). J’en ai profité pour virer la mention Thaulk de mes couvertures à la façon des éditeurs américains qui vendent des textes plutôt que de se vendre eux-mêmes (j’ai souvent tenté de faire supprimer le logo de mes éditeurs sans succès).

[![Couverture rééditions](_i/2couvs.webp)](/bibliographie/)
...
![Mon bureau](_i/ulysses.png)3. Je commence par préparer la version papier. J’ai créé un gabarit CreateSpace sous InDesign. Pour mes nouveaux textes, j’ai choisi le format 5,25" x 8" (13,335 x 20,32 mm), soit pratiquement le format de la collection Blanche de Gallimard.
![Gabarit InDesign](_i/double.png)5. Je travaille sur des pages justifiées en 90 mm avec une marge intérieure bien supérieure à la marge extérieure (sinon la reliure est trop proche du texte). Je compose le corps de texte en Warnock Pro 11,5 pt interligné 13,8 pt. Pour la titraille, j’utilise du Proxima Nova qu’on retrouve sur mes couvertures.
...
[![Ératosthène](_i/pbeta.webp)](/eratosthene/)
![La mécanique du texte](_i/ptextmeca.webp)15. Il est temps alors de fixer le prix de vente. Je me suis fait un petit tableau sous Excel que je vous livre. En fonction de la pagination, CreateSpace calcule un prix minimum (prix de fabrication). Je lui ajoute la marge théorique que j’aimerais me faire par exemplaire et j’obtiens un prix public que j’arrondis. CreateSpace me donne alors ma marge réelle sur Amazon.
![Prix](_i/tab.png)17. Il est temps de passer à la version ebook. Pour créer l’epub, je pourrais exporter directement depuis Ulysses et retoucher le fichier sur [Sigil](https://github.com/Sigil-Ebook/Sigil), mais cette méthode ne me convient pas. Je préfère exporter depuis Ulysses en HTML et convertir en epub avec un script maison, j’ai ainsi beaucoup plus de contrôle sur le rendu final, et surtout je peux regénérer mon epub aussi souvent que nécessaire (et ça ne me prends un rien de temps).
18. J’attribue un ISBN à mon epub (quand j’ai créé Thaulk, j’ai gratuitement récupéré une liste de 50 numéros dans laquelle je puise depuis).
19. Je diffuse le texte sur Immatériel chez qui je suis enregistré avec Thaulk comme éditeur. Je peux fournir une couverture, un ISBN ebook, mais aussi celui papier fourni par CreateSpace (ainsi Amazon lie les deux versions du texte et laisse le choix du format à l’acheteur).
20. Pour le prix ebook, je veux qu’il soit au moins deux fois inférieur à la version papier.
21. Résultat, je peux vendre mes livres moins cher qu’avant, les offrir dans une qualité au moins égale et gagner deux à trois fois plus par exemplaire (ce qui n’est pas un enjeu d’importance vu mes volumes de vente).
22. Je ne vous cache pas que l’opération prend du temps. Une très grosse journée de travail au minimum une fois le processus institué en routine. Mais c’est un engagement, une façon pour moi d’aligner mes actes avec mes idées.
...
#edition #dialogue #y2016 #2016-8-4-9h55
