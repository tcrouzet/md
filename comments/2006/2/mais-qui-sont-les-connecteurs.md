[Mais qui sont les connecteurs ?](../../../2006/2/mais-qui-sont-les-connecteurs.md)

---
nCharles Granger @ 2006-02-23 21:33:58
...
Je me suis déjà plusieurs fois expliqué sur les raisons des "ne pas", notamment dans l’interview avec [Denis Failly](http://nextmodernitylibrary.blogspirit.com/archive/2006/02/27/le-peuple-des-connecteurs-ils-ne-votent-pas-ils-n-etudient-p.html). C’est une façon de définir les connecteurs par rapport à ce que nous connaissons tous (la démocratie, le travail, les études...). Tout au long du livre je suis positif puisque je dis que nous changeons le monde : je ne cesse de proposer des solutions.

Je me suis essayé à une définition de connecteur purement positive, j’espère, avec mon [initiative connecteur](http://blog.tcrouzet.com/initiative.php).

Maintenant, je peux aussi justifier les "ne pas" d’un pur point de vue marketing. Ils étaient une tentative d’attirer l’attention, notamment sur la couverture. Beaucoup de gens me reprochent ce côté trash. Avec le recul, ils n’ont sans doute pas tors. Les gens regardent le livre avec un a priori négatif alors que je ne cesse de positiver à l’intérieur. Pour preuve lisez le commentaire de [Charles Granger](http://blog.tcrouzet.com/peuple/connecteurs-35474"). Je vous jure ce n’est pas un de mes amis.
